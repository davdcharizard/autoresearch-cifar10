...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/in/cinyuvjglmetd4cmoff5y2kwx456aqrnhrn2qjso7vgfxjnrfy6p.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
#   %getitem_35 : Tensor "bf16[512, 256, 3, 3][2304, 1, 768, 256]cuda:0" = PlaceHolder[target=getitem_35]
#   %convert_element_type_53 : Tensor "f32[512, 256, 3, 3][2304, 1, 768, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%getitem_35, torch.float32), kwargs = {})
...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/dl/cdlaj66gxp5g4rhv53cr6pupxxtqde5qbwzq5w7v75epo54nbfsv.py
...
#   %relu_6 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%convert_element_type_22,), kwargs = {})
#   return %relu_6
...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/mn/cmnimxnoybq77n2vor4s7ntqeety2quvtxfyggwzogiunh424xze.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum]
# Source node to ATen node mapping:
# Graph fragment:
#   %getitem_34 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0" = PlaceHolder[target=getitem_34]
#   %relu_6 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0" = PlaceHolder[target=relu_6]
#   %convert_element_type_52 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%getitem_34, torch.float32), kwargs = {})
#   %mul_101 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_52, %relu_6), kwargs = {})
...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/r6/cr6mjyt4zotsvxzup2xoekkyrc26jnp77onuc37p42b4ifqjyb54.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum]
# Source node to ATen node mapping:
# Graph fragment:
#   %buf42 : Tensor "f32[1, 1, 1, 1, 256, 256][65536, 65536, 65536, 65536, 256, 1]cuda:0" = PlaceHolder[target=buf42]
#   %convert_element_type_52 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%getitem_34, torch.float32), kwargs = {})
#   %mul_101 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_52, %relu_6), kwargs = {})
#   %sum_7 : Tensor "f32[1, 1, 1, 1][1, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_101, [0, 1, 2, 3], True), kwargs = {dtype: torch.float32})
#   return %buf43
...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/ev/cevny7gftxr6rp5gyelzdwhem7rnop3dnix2jw6z4hu73r67rn75.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum]
# Source node to ATen node mapping:
# Graph fragment:
#   %buf43 : Tensor "f32[1, 1, 1, 1, 256][256, 256, 256, 256, 1]cuda:0" = PlaceHolder[target=buf43]
#   %convert_element_type_52 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%getitem_34, torch.float32), kwargs = {})
#   %mul_101 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_52, %relu_6), kwargs = {})
#   %sum_7 : Tensor "f32[1, 1, 1, 1][1, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_101, [0, 1, 2, 3], True), kwargs = {dtype: torch.float32})
#   return %sum_7
...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/c7/cc7dcpzk4sqw6raebxxvushzwpojeeuv64rltmsfyng7a3gvcv25.py
...
#   %full_default : Tensor "bf16[][]cuda:0"[num_users=10] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %convert_element_type_52 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%getitem_34, torch.float32), kwargs = {})
#   %mul_100 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_52, %primals_33), kwargs = {})
#   %convert_element_type_55 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_100, torch.bfloat16), kwargs = {})
#   %le_3 : Tensor "b8[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.le.Scalar](args = (%relu_6, 0), kwargs = {})
#   %where_3 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%le_3, %full_default, %convert_element_type_55), kwargs = {})
#   %convert_element_type_56 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%where_3, torch.float32), kwargs = {})
...
#   %unsqueeze_76 : Tensor "f32[1, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%squeeze_18, 0), kwargs = {})
#   %unsqueeze_77 : Tensor "f32[1, 256, 1][256, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_76, 2), kwargs = {})
#   %unsqueeze_78 : Tensor "f32[1, 256, 1, 1][256, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_77, 3), kwargs = {})
#   %sum_8 : Tensor "f32[256][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%convert_element_type_56, [0, 2, 3]), kwargs = {})
...
#   %sub_22 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convert_element_type_21, %unsqueeze_78), kwargs = {})
#   %mul_102 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_56, %sub_22), kwargs = {})
#   %sum_9 : Tensor "f32[256][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_102, [0, 2, 3]), kwargs = {})
#   return %buf45,%buf47
...
def triton_red_fused__native_batch_norm_legit_functional__to_copy_mul_native_batch_norm_backward_threshold_backward_23(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        tmp14 = tl.load(in_ptr3 + (x0 + 256*r0_2 + 32768*x1), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp1 = 0.0
        tmp2 = tmp0 <= tmp1
...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/5a/c5a6n4bllz4surunziv7saqvv735khaalj7xcngbqmqgegtax6tr.py
...
# Source node to ATen node mapping:
# Graph fragment:
#   %buf45 : Tensor "f32[256, 256][1, 256]cuda:0" = PlaceHolder[target=buf45]
#   %full_default : Tensor "bf16[][]cuda:0"[num_users=10] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %convert_element_type_52 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%getitem_34, torch.float32), kwargs = {})
#   %mul_100 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_52, %primals_33), kwargs = {})
#   %convert_element_type_55 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_100, torch.bfloat16), kwargs = {})
...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/2q/c2qsqm7mf7hrefmzn23ndj5s2e2ary37is422eef7ljo5ewskbgm.py
# Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.threshold_backward, aten._to_copy, aten.mul, aten.native_batch_norm_backward, aten._native_batch_norm_legit_functional]
# Source node to ATen node mapping:
#   input_23 => convert_element_type_21, squeeze_18, squeeze_19
# Graph fragment:
#   %buf47 : Tensor "f32[256, 256][1, 256]cuda:0" = PlaceHolder[target=buf47]
#   %sum_9 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=sum_9]
#   %rsqrt_6 : Tensor "f32[1, 256, 1, 1][256, 1, 256, 256]cuda:0" = PlaceHolder[target=rsqrt_6]
#   %full_default : Tensor "bf16[][]cuda:0"[num_users=10] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %convert_element_type_52 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%getitem_34, torch.float32), kwargs = {})
#   %mul_100 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_52, %primals_33), kwargs = {})
...
#   %mul_102 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_56, %sub_22), kwargs = {})
#   %sum_9 : Tensor "f32[256][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_102, [0, 2, 3]), kwargs = {})
#   %squeeze_19 : Tensor "f32[256][1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.squeeze.dims](args = (%rsqrt_6, [0, 2, 3]), kwargs = {})
#   %mul_110 : Tensor "f32[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_9, %squeeze_19), kwargs = {})
...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/fp/cfpgmdazzgbito4tatgkukqa5ww25mp2butxzoi4n2dn4tuihp2l.py
...
#   %sum_9 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=sum_9]
#   %rsqrt_6 : Tensor "f32[1, 256, 1, 1][256, 1, 256, 256]cuda:0" = PlaceHolder[target=rsqrt_6]
#   %sum_8 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=sum_8]
#   %primals_44 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=primals_44]
#   %mul_109 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0" = PlaceHolder[target=mul_109]
#   %full_default : Tensor "bf16[][]cuda:0"[num_users=10] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %convert_element_type_52 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%getitem_34, torch.float32), kwargs = {})
#   %mul_100 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_52, %primals_33), kwargs = {})
#   %convert_element_type_55 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_100, torch.bfloat16), kwargs = {})
...
#   %convert_element_type_21 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%convolution_7, torch.float32), kwargs = {})
#   %sub_22 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convert_element_type_21, %unsqueeze_78), kwargs = {})
#   %mul_103 : Tensor "f32[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_8, 3.0517578125e-05), kwargs = {})
#   %unsqueeze_79 : Tensor "f32[1, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_103, 0), kwargs = {})
#   %unsqueeze_80 : Tensor "f32[1, 256, 1][256, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_79, 2), kwargs = {})
#   %unsqueeze_81 : Tensor "f32[1, 256, 1, 1][256, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_80, 3), kwargs = {})
#   %mul_104 : Tensor "f32[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_9, 3.0517578125e-05), kwargs = {})
#   %squeeze_19 : Tensor "f32[256][1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.squeeze.dims](args = (%rsqrt_6, [0, 2, 3]), kwargs = {})
#   %mul_105 : Tensor "f32[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%squeeze_19, %squeeze_19), kwargs = {})
#   %mul_106 : Tensor "f32[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_104, %mul_105), kwargs = {})
#   %unsqueeze_82 : Tensor "f32[1, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_106, 0), kwargs = {})
#   %unsqueeze_83 : Tensor "f32[1, 256, 1][256, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_82, 2), kwargs = {})
#   %unsqueeze_84 : Tensor "f32[1, 256, 1, 1][256, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_83, 3), kwargs = {})
#   %mul_107 : Tensor "f32[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%squeeze_19, %primals_44), kwargs = {})
#   %unsqueeze_85 : Tensor "f32[1, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_107, 0), kwargs = {})
#   %unsqueeze_86 : Tensor "f32[1, 256, 1][256, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_85, 2), kwargs = {})
#   %unsqueeze_87 : Tensor "f32[1, 256, 1, 1][256, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_86, 3), kwargs = {})
#   %mul_108 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_22, %unsqueeze_84), kwargs = {})
#   %sub_24 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convert_element_type_56, %mul_108), kwargs = {})
#   %sub_25 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%sub_24, %unsqueeze_81), kwargs = {})
#   %mul_109 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_25, %unsqueeze_87), kwargs = {})
#   %convert_element_type_58 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_109, torch.bfloat16), kwargs = {})
...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/gd/cgdbsxzxu7frau3i7y7jj5na2lhctnmec5jlawdwxx6umkwfztit.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
#   %getitem_38 : Tensor "bf16[256, 256, 3, 3][2304, 1, 768, 256]cuda:0" = PlaceHolder[target=getitem_38]
#   %convert_element_type_59 : Tensor "f32[256, 256, 3, 3][2304, 1, 768, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%getitem_38, torch.float32), kwargs = {})
...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/sz/csza6k3w3y6yr6j64li3u4shlsanebc5ztfq5xhc4lz6pcajfa5a.py
...
# Graph fragment:
#   %relu_5 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0" = PlaceHolder[target=relu_5]
#   %getitem_37 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0" = PlaceHolder[target=getitem_37]
#   %convolution_6 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0" = PlaceHolder[target=convolution_6]
#   %unsqueeze_90 : Tensor "f32[1, 256, 1, 1][256, 1, 1, 1]cuda:0" = PlaceHolder[target=unsqueeze_90]
#   %full_default : Tensor "bf16[][]cuda:0"[num_users=10] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %le_4 : Tensor "b8[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.le.Scalar](args = (%relu_5, 0), kwargs = {})
#   %where_4 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%le_4, %full_default, %getitem_37), kwargs = {})
#   %convert_element_type_60 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%where_4, torch.float32), kwargs = {})
#   %sum_10 : Tensor "f32[256][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%convert_element_type_60, [0, 2, 3]), kwargs = {})
...
#   %sub_26 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convert_element_type_18, %unsqueeze_90), kwargs = {})
#   %mul_111 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_60, %sub_26), kwargs = {})
#   %sum_11 : Tensor "f32[256][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_111, [0, 2, 3]), kwargs = {})
#   return %buf56,%buf58
...
def triton_red_fused__native_batch_norm_legit_functional_native_batch_norm_backward_threshold_backward_28(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        tmp0 = tl.load(in_ptr0 + (x0 + 256*r0_2 + 32768*x1), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp3 = tl.load(in_ptr1 + (x0 + 256*r0_2 + 32768*x1), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp9 = tl.load(in_ptr2 + (x0 + 256*r0_2 + 32768*x1), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp1 = 0.0
        tmp2 = tmp0 <= tmp1
        tmp4 = tl.where(tmp2, tmp1, tmp3)
        tmp5 = tmp4.to(tl.float32)
...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/hl/chlcnpaypc24tfqt5j7akm7ltr63hi6k47ribodcviyootnqrd5e.py
...
#   %convolution_6 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0" = PlaceHolder[target=convolution_6]
#   %unsqueeze_90 : Tensor "f32[1, 256, 1, 1][256, 1, 1, 1]cuda:0" = PlaceHolder[target=unsqueeze_90]
#   %sum_11 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=sum_11]
#   %squeeze_16 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=squeeze_16]
#   %sum_10 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=sum_10]
...
#   %convert_element_type_18 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%convolution_6, torch.float32), kwargs = {})
#   %sub_26 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convert_element_type_18, %unsqueeze_90), kwargs = {})
#   %mul_112 : Tensor "f32[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_10, 3.0517578125e-05), kwargs = {})
#   %unsqueeze_91 : Tensor "f32[1, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_112, 0), kwargs = {})
#   %unsqueeze_92 : Tensor "f32[1, 256, 1][256, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_91, 2), kwargs = {})
#   %unsqueeze_93 : Tensor "f32[1, 256, 1, 1][256, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_92, 3), kwargs = {})
#   %mul_113 : Tensor "f32[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_11, 3.0517578125e-05), kwargs = {})
#   %mul_114 : Tensor "f32[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%squeeze_16, %squeeze_16), kwargs = {})
#   %mul_115 : Tensor "f32[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_113, %mul_114), kwargs = {})
#   %unsqueeze_94 : Tensor "f32[1, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_115, 0), kwargs = {})
#   %unsqueeze_95 : Tensor "f32[1, 256, 1][256, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_94, 2), kwargs = {})
#   %unsqueeze_96 : Tensor "f32[1, 256, 1, 1][256, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_95, 3), kwargs = {})
#   %mul_116 : Tensor "f32[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%squeeze_16, %primals_38), kwargs = {})
#   %unsqueeze_97 : Tensor "f32[1, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_116, 0), kwargs = {})
#   %unsqueeze_98 : Tensor "f32[1, 256, 1][256, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_97, 2), kwargs = {})
#   %unsqueeze_99 : Tensor "f32[1, 256, 1, 1][256, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_98, 3), kwargs = {})
#   %mul_117 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_26, %unsqueeze_96), kwargs = {})
#   %sub_28 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convert_element_type_60, %mul_117), kwargs = {})
#   %sub_29 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%sub_28, %unsqueeze_93), kwargs = {})
#   %mul_118 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_29, %unsqueeze_99), kwargs = {})
#   %convert_element_type_62 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_118, torch.bfloat16), kwargs = {})
...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/sr/csrfh27a5lib3z5oqbt2jjxwkqf2zhltqziirzhxbjk2bqbecn5u.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.add]
# Source node to ATen node mapping:
# Graph fragment:
#   %getitem_34 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0" = PlaceHolder[target=getitem_34]
#   %getitem_40 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0" = PlaceHolder[target=getitem_40]
#   %convert_element_type_52 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%getitem_34, torch.float32), kwargs = {})
#   %convert_element_type_54 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%convert_element_type_52, torch.bfloat16), kwargs = {})
#   %add_54 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_54, %getitem_40), kwargs = {})
#   return %add_54
...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/vy/cvyfesy7z6lxinhm263akzzgcbppo755v7ykqsfl72dnnkj6z3vd.py
...
# Graph fragment:
#   %getitem_13 : Tensor "i8[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0" = PlaceHolder[target=getitem_13]
#   %add_54 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0" = PlaceHolder[target=add_54]
#   %convert_element_type_52 : Tensor "f32[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%getitem_34, torch.float32), kwargs = {})
#   %convert_element_type_54 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%convert_element_type_52, torch.bfloat16), kwargs = {})
#   %add_54 : Tensor "bf16[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_54, %getitem_40), kwargs = {})
#   %_low_memory_max_pool_offsets_to_indices_1 : Tensor "i64[512, 256, 8, 8][16384, 1, 2048, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.prims._low_memory_max_pool_offsets_to_indices.default](args = (%getitem_13, [2, 2], [16, 16], [2, 2], [0, 0], [1, 1]), kwargs = {})
#   %max_pool2d_with_indices_backward_2 : Tensor "bf16[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.max_pool2d_with_indices_backward.default](args = (%add_54, %relu_4, [2, 2], [2, 2], [0, 0], [1, 1], False, %_low_memory_max_pool_offsets_to_indices_1), kwargs = {})
...
def triton_poi_fused__to_copy_add_max_pool2d_with_indices_max_pool2d_with_indices_backward_31(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x4 = ((xindex // 256) % 256)
    x5 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + 256*((((0) * ((0) >= (x1 // 2)) + (x1 // 2) * ((x1 // 2) > (0)))) * ((((0) * ((0) >= (x1 // 2)) + (x1 // 2) * ((x1 // 2) > (0)))) <= ((-1) + ((8) * ((8) <= (1 + (x1 // 2))) + (1 + (x1 // 2)) * ((1 + (x1 // 2)) < (8))))) + ((-1) + ((8) * ((8) <= (1 + (x1 // 2))) + (1 + (x1 // 2)) * ((1 + (x1 // 2)) < (8)))) * (((-1) + ((8) * ((8) <= (1 + (x1 // 2))) + (1 + (x1 // 2)) * ((1 + (x1 // 2)) < (8)))) < (((0) * ((0) >= (x1 // 2)) + (x1 // 2) * ((x1 // 2) > (0)))))) + 2048*((((0) * ((0) >= (x2 // 2)) + (x2 // 2) * ((x2 // 2) > (0)))) * ((((0) * ((0) >= (x2 // 2)) + (x2 // 2) * ((x2 // 2) > (0)))) <= ((-1) + ((8) * ((8) <= (1 + (x2 // 2))) + (1 + (x2 // 2)) * ((1 + (x2 // 2)) < (8))))) + ((-1) + ((8) * ((8) <= (1 + (x2 // 2))) + (1 + (x2 // 2)) * ((1 + (x2 // 2)) < (8)))) * (((-1) + ((8) * ((8) <= (1 + (x2 // 2))) + (1 + (x2 // 2)) * ((1 + (x2 // 2)) < (8)))) < (((0) * ((0) >= (x2 // 2)) + (x2 // 2) * ((x2 // 2) > (0)))))) + 16384*x3), None)
    tmp6 = tl.load(in_ptr1 + (x0 + 256*((((0) * ((0) >= (x1 // 2)) + (x1 // 2) * ((x1 // 2) > (0)))) * ((((0) * ((0) >= (x1 // 2)) + (x1 // 2) * ((x1 // 2) > (0)))) <= ((-1) + ((8) * ((8) <= (1 + (x1 // 2))) + (1 + (x1 // 2)) * ((1 + (x1 // 2)) < (8))))) + ((-1) + ((8) * ((8) <= (1 + (x1 // 2))) + (1 + (x1 // 2)) * ((1 + (x1 // 2)) < (8)))) * (((-1) + ((8) * ((8) <= (1 + (x1 // 2))) + (1 + (x1 // 2)) * ((1 + (x1 // 2)) < (8)))) < (((0) * ((0) >= (x1 // 2)) + (x1 // 2) * ((x1 // 2) > (0)))))) + 2048*((((0) * ((0) >= (x2 // 2)) + (x2 // 2) * ((x2 // 2) > (0)))) * ((((0) * ((0) >= (x2 // 2)) + (x2 // 2) * ((x2 // 2) > (0)))) <= ((-1) + ((8) * ((8) <= (1 + (x2 // 2))) + (1 + (x2 // 2)) * ((1 + (x2 // 2)) < (8))))) + ((-1) + ((8) * ((8) <= (1 + (x2 // 2))) + (1 + (x2 // 2)) * ((1 + (x2 // 2)) < (8)))) * (((-1) + ((8) * ((8) <= (1 + (x2 // 2))) + (1 + (x2 // 2)) * ((1 + (x2 // 2)) < (8)))) < (((0) * ((0) >= (x2 // 2)) + (x2 // 2) * ((x2 // 2) > (0)))))) + 16384*x3), None).to(tl.float32)
    tmp1 = tl.full([XBLOCK], 4, tl.int32)
    tmp2 = tmp0 + tmp1
    tmp3 = tmp0 < 0
    tmp4 = tl.where(tmp3, tmp2, tmp0)
...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/vb/cvbzje2zh5auy4ft4is7ciobcwa3a5h43dziliknzcv2nrntt7b5.py
...
#   %max_pool2d_with_indices_backward_2 : Tensor "bf16[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0" = PlaceHolder[target=max_pool2d_with_indices_backward_2]
#   %convolution_5 : Tensor "bf16[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0" = PlaceHolder[target=convolution_5]
#   %unsqueeze_102 : Tensor "f32[1, 256, 1, 1][256, 1, 1, 1]cuda:0" = PlaceHolder[target=unsqueeze_102]
#   %full_default : Tensor "bf16[][]cuda:0"[num_users=10] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %le_5 : Tensor "b8[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.le.Scalar](args = (%relu_4, 0), kwargs = {})
#   %where_5 : Tensor "bf16[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%le_5, %full_default, %max_pool2d_with_indices_backward_2), kwargs = {})
#   %convert_element_type_64 : Tensor "f32[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%where_5, torch.float32), kwargs = {})
#   %sum_12 : Tensor "f32[256][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%convert_element_type_64, [0, 2, 3]), kwargs = {})
...
#   %sub_30 : Tensor "f32[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convert_element_type_15, %unsqueeze_102), kwargs = {})
#   %mul_120 : Tensor "f32[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_64, %sub_30), kwargs = {})
#   %sum_13 : Tensor "f32[256][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_120, [0, 2, 3]), kwargs = {})
#   return %buf68,%buf70
...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/sn/csnilajvo4gtrlep64jzufpbjkc3gjebz4xc5uedoo6nkj7hgusw.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.threshold_backward, aten.native_batch_norm_backward]
# Source node to ATen node mapping:
# Graph fragment:
#   %buf68 : Tensor "f32[256, 310][1, 256]cuda:0" = PlaceHolder[target=buf68]
#   %full_default : Tensor "bf16[][]cuda:0"[num_users=10] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %le_5 : Tensor "b8[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.le.Scalar](args = (%relu_4, 0), kwargs = {})
#   %where_5 : Tensor "bf16[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%le_5, %full_default, %max_pool2d_with_indices_backward_2), kwargs = {})
#   %convert_element_type_64 : Tensor "f32[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%where_5, torch.float32), kwargs = {})
...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/r6/cr66jow7aubn6aodv6uadqqko2ahf5g2br4ccseuhc7zdkcbhxhb.py
# Topologically Sorted Source Nodes: [input_16], Original ATen: [aten.threshold_backward, aten.native_batch_norm_backward, aten._native_batch_norm_legit_functional]
# Source node to ATen node mapping:
#   input_16 => convert_element_type_15
# Graph fragment:
#   %buf70 : Tensor "f32[256, 310][1, 256]cuda:0" = PlaceHolder[target=buf70]
#   %sum_13 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=sum_13]
#   %squeeze_13 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=squeeze_13]
#   %full_default : Tensor "bf16[][]cuda:0"[num_users=10] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %le_5 : Tensor "b8[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.le.Scalar](args = (%relu_4, 0), kwargs = {})
#   %where_5 : Tensor "bf16[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%le_5, %full_default, %max_pool2d_with_indices_backward_2), kwargs = {})
#   %convert_element_type_64 : Tensor "f32[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%where_5, torch.float32), kwargs = {})
...
#   %mul_120 : Tensor "f32[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_64, %sub_30), kwargs = {})
#   %sum_13 : Tensor "f32[256][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_120, [0, 2, 3]), kwargs = {})
#   %mul_128 : Tensor "f32[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_13, %squeeze_13), kwargs = {})
...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/hr/chr7bwwztamaqwwnskz5wik3bjsr6yeprakojfzacaloalyzjf3p.py
...
#   %sum_13 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=sum_13]
#   %squeeze_13 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=squeeze_13]
#   %sum_12 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=sum_12]
...
#   %convert_element_type_15 : Tensor "f32[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%convolution_5, torch.float32), kwargs = {})
#   %sub_30 : Tensor "f32[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convert_element_type_15, %unsqueeze_102), kwargs = {})
#   %mul_121 : Tensor "f32[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_12, 7.62939453125e-06), kwargs = {})
#   %unsqueeze_103 : Tensor "f32[1, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_121, 0), kwargs = {})
#   %unsqueeze_104 : Tensor "f32[1, 256, 1][256, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_103, 2), kwargs = {})
#   %unsqueeze_105 : Tensor "f32[1, 256, 1, 1][256, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_104, 3), kwargs = {})
#   %mul_122 : Tensor "f32[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_13, 7.62939453125e-06), kwargs = {})
#   %mul_123 : Tensor "f32[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%squeeze_13, %squeeze_13), kwargs = {})
#   %mul_124 : Tensor "f32[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_122, %mul_123), kwargs = {})
#   %unsqueeze_106 : Tensor "f32[1, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_124, 0), kwargs = {})
#   %unsqueeze_107 : Tensor "f32[1, 256, 1][256, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_106, 2), kwargs = {})
#   %unsqueeze_108 : Tensor "f32[1, 256, 1, 1][256, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_107, 3), kwargs = {})
#   %mul_125 : Tensor "f32[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%squeeze_13, %primals_31), kwargs = {})
#   %unsqueeze_109 : Tensor "f32[1, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_125, 0), kwargs = {})
#   %unsqueeze_110 : Tensor "f32[1, 256, 1][256, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_109, 2), kwargs = {})
#   %unsqueeze_111 : Tensor "f32[1, 256, 1, 1][256, 1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_110, 3), kwargs = {})
#   %mul_126 : Tensor "f32[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_30, %unsqueeze_108), kwargs = {})
#   %sub_32 : Tensor "f32[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convert_element_type_64, %mul_126), kwargs = {})
#   %sub_33 : Tensor "f32[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%sub_32, %unsqueeze_105), kwargs = {})
#   %mul_127 : Tensor "f32[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_33, %unsqueeze_111), kwargs = {})
#   %convert_element_type_66 : Tensor "bf16[512, 256, 16, 16][65536, 1, 4096, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_127, torch.bfloat16), kwargs = {})
...
# kernel path: /SPXvePFS/users/david/autoresearch-benchmarks/autoresearch-cifar10/runs/v3.0.0-opus-4-8/.autoresearch/goals/maximize-cifar10-test-accuracy/experiments/014/.inductor_cache/ap/capdnmtptqzwwn4wt3nhavsmw5h2pe3rb2qpvbaehzviz3nieny7.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
#   %getitem_44 : Tensor "bf16[256, 128, 3, 3][1152, 1, 384, 128]cuda:0" = PlaceHolder[target=getitem_44]
#   %convert_element_type_67 : Tensor "f32[256, 128, 3, 3][1152, 1, 384, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%getitem_44, torch.float32), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        assert_size_stride(convert_element_type_14, (256, 128, 3, 3), (1152, 1, 384, 128))
        assert_size_stride(convolution_5, (512, 256, 16, 16), (65536, 1, 4096, 256))
        assert_size_stride(squeeze_13, (256, ), (1, ))
        assert_size_stride(relu_4, (512, 256, 16, 16), (65536, 1, 4096, 256))
        assert_size_stride(getitem_12, (512, 256, 8, 8), (16384, 1, 2048, 256))
        assert_size_stride(getitem_13, (512, 256, 8, 8), (16384, 1, 2048, 256))
        assert_size_stride(convert_element_type_17, (256, 256, 3, 3), (2304, 1, 768, 256))
        assert_size_stride(convolution_6, (512, 256, 8, 8), (16384, 1, 2048, 256))
        assert_size_stride(squeeze_16, (256, ), (1, ))
        assert_size_stride(relu_5, (512, 256, 8, 8), (16384, 1, 2048, 256))
        assert_size_stride(convert_element_type_20, (256, 256, 3, 3), (2304, 1, 768, 256))
        assert_size_stride(convolution_7, (512, 256, 8, 8), (16384, 1, 2048, 256))
        assert_size_stride(getitem_17, (1, 256, 1, 1), (256, 1, 256, 256))
        assert_size_stride(rsqrt_6, (1, 256, 1, 1), (256, 1, 256, 256))
        assert_size_stride(convert_element_type_23, (512, 256, 3, 3), (2304, 1, 768, 256))
        assert_size_stride(convert_element_type_24, (512, 256, 8, 8), (16384, 1, 2048, 256))
        ...
        assert_size_stride(unsqueeze_90, (1, 256, 1, 1), (256, 1, 1, 1))
        assert_size_stride(unsqueeze_102, (1, 256, 1, 1), (256, 1, 1, 1))
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            buf37 = buf36[0]
            assert_size_stride(buf37, (512, 256, 8, 8), (16384, 1, 2048, 256), 'torch.ops.aten.convolution_backward.default')
            assert_alignment(buf37, 16, 'torch.ops.aten.convolution_backward.default')
            buf38 = buf36[1]
            assert_size_stride(buf38, (512, 256, 3, 3), (2304, 1, 768, 256), 'torch.ops.aten.convolution_backward.default')
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_18.run(buf38, buf39, 1179648, stream=stream0)
            del buf38
            buf40 = empty_strided_cuda((512, 256, 8, 8), (16384, 1, 2048, 256), torch.bfloat16)
            # Topologically Sorted Source Nodes: [input_23, input_24], Original ATen: [aten._native_batch_norm_legit_functional, aten.relu]
            stream0 = get_raw_stream(0)
            triton_poi_fused__native_batch_norm_legit_functional_relu_19.run(convolution_7, getitem_17, rsqrt_6, primals_44, primals_45, buf40, 8388608, stream=stream0)
            del primals_45
            buf42 = reinterpret_tensor(buf32, (1, 1, 1, 1, 256, 256), (65536, 65536, 65536, 65536, 256, 1), 0); del buf32  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_mul_sum_20.run(buf37, buf40, buf42, 65536, 128, stream=stream0)
            buf43 = empty_strided_cuda((1, 1, 1, 1, 256), (256, 256, 256, 256, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_mul_sum_21.run(buf42, buf43, 256, 256, stream=stream0)
            buf44 = empty_strided_cuda((1, 1, 1, 1), (1, 1, 1, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.sum]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_mul_sum_22.run(buf43, buf44, 1, 256, stream=stream0)
            buf45 = reinterpret_tensor(buf42, (256, 256), (1, 256), 0); del buf42  # reuse
            buf47 = reinterpret_tensor(buf30, (256, 256), (1, 256), 0); del buf30  # reuse
            # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.threshold_backward, aten._to_copy, aten.mul, aten.native_batch_norm_backward, aten._native_batch_norm_legit_functional]
            stream0 = get_raw_stream(0)
            triton_red_fused__native_batch_norm_legit_functional__to_copy_mul_native_batch_norm_backward_threshold_backward_23.run(buf40, buf37, primals_33, convolution_7, getitem_17, buf45, buf47, 65536, 128, stream=stream0)
            buf46 = reinterpret_tensor(buf43, (256, ), (1, ), 0); del buf43  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.threshold_backward, aten._to_copy, aten.mul, aten.native_batch_norm_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_mul_native_batch_norm_backward_threshold_backward_24.run(buf45, buf46, 256, 256, stream=stream0)
            buf48 = empty_strided_cuda((256, ), (1, ), torch.float32)
            buf50 = empty_strided_cuda((256, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.threshold_backward, aten._to_copy, aten.mul, aten.native_batch_norm_backward, aten._native_batch_norm_legit_functional]
            stream0 = get_raw_stream(0)
            triton_red_fused__native_batch_norm_legit_functional__to_copy_mul_native_batch_norm_backward_threshold_backward_25.run(buf47, rsqrt_6, buf48, buf50, 256, 256, stream=stream0)
            buf51 = empty_strided_cuda((512, 256, 8, 8), (16384, 1, 2048, 256), torch.bfloat16)
            # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.threshold_backward, aten._to_copy, aten.mul, aten.native_batch_norm_backward, aten._native_batch_norm_legit_functional, aten.convolution_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused__native_batch_norm_legit_functional__to_copy_convolution_backward_mul_native_batch_norm_backward_threshold_backward_26.run(buf40, buf37, primals_33, convolution_7, getitem_17, buf48, rsqrt_6, buf46, primals_44, buf51, 8388608, stream=stream0)
            del buf40
            del convolution_7
            del getitem_17
            del primals_33
            ...
            buf53 = buf52[0]
            assert_size_stride(buf53, (512, 256, 8, 8), (16384, 1, 2048, 256), 'torch.ops.aten.convolution_backward.default')
            assert_alignment(buf53, 16, 'torch.ops.aten.convolution_backward.default')
            buf54 = buf52[1]
            assert_size_stride(buf54, (256, 256, 3, 3), (2304, 1, 768, 256), 'torch.ops.aten.convolution_backward.default')
            assert_alignment(buf54, 16, 'torch.ops.aten.convolution_backward.default')
            del buf52
            buf55 = empty_strided_cuda((256, 256, 3, 3), (2304, 1, 768, 256), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_27.run(buf54, buf55, 589824, stream=stream0)
            del buf54
            buf56 = buf47; del buf47  # reuse
            buf58 = buf45; del buf45  # reuse
            # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.threshold_backward, aten.native_batch_norm_backward, aten._native_batch_norm_legit_functional]
            stream0 = get_raw_stream(0)
            triton_red_fused__native_batch_norm_legit_functional_native_batch_norm_backward_threshold_backward_28.run(relu_5, buf53, convolution_6, unsqueeze_90, buf56, buf58, 65536, 128, stream=stream0)
            buf57 = buf48; del buf48  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.threshold_backward, aten.native_batch_norm_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_mul_native_batch_norm_backward_threshold_backward_24.run(buf56, buf57, 256, 256, stream=stream0)
            buf59 = empty_strided_cuda((256, ), (1, ), torch.float32)
            buf60 = empty_strided_cuda((256, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.threshold_backward, aten.native_batch_norm_backward, aten._native_batch_norm_legit_functional]
            stream0 = get_raw_stream(0)
            triton_red_fused__native_batch_norm_legit_functional__to_copy_mul_native_batch_norm_backward_threshold_backward_25.run(buf58, squeeze_16, buf59, buf60, 256, 256, stream=stream0)
            buf61 = relu_5; del relu_5  # reuse
            # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.threshold_backward, aten.native_batch_norm_backward, aten._native_batch_norm_legit_functional, aten.convolution_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused__native_batch_norm_legit_functional_convolution_backward_native_batch_norm_backward_threshold_backward_29.run(buf61, buf53, convolution_6, unsqueeze_90, buf59, squeeze_16, buf57, primals_38, 8388608, stream=stream0)
            del buf53
            del convolution_6
            del primals_38
            del squeeze_16
            ...
            del getitem_12
            buf63 = buf62[0]
            assert_size_stride(buf63, (512, 256, 8, 8), (16384, 1, 2048, 256), 'torch.ops.aten.convolution_backward.default')
            assert_alignment(buf63, 16, 'torch.ops.aten.convolution_backward.default')
            buf64 = buf62[1]
            assert_size_stride(buf64, (256, 256, 3, 3), (2304, 1, 768, 256), 'torch.ops.aten.convolution_backward.default')
            assert_alignment(buf64, 16, 'torch.ops.aten.convolution_backward.default')
            del buf62
            buf65 = empty_strided_cuda((256, 256, 3, 3), (2304, 1, 768, 256), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_27.run(buf64, buf65, 589824, stream=stream0)
            del buf64
            buf66 = buf37; del buf37  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_30.run(buf66, buf63, 8388608, stream=stream0)
            del buf63
            buf67 = empty_strided_cuda((512, 256, 16, 16), (65536, 1, 4096, 256), torch.bfloat16)
            # Topologically Sorted Source Nodes: [input_18], Original ATen: [aten._to_copy, aten.add, aten.max_pool2d_with_indices, aten.max_pool2d_with_indices_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_max_pool2d_with_indices_max_pool2d_with_indices_backward_31.run(getitem_13, buf66, buf67, 33554432, stream=stream0)
            del buf66
            del getitem_13
            buf68 = empty_strided_cuda((256, 310), (1, 256), torch.float32)
            buf70 = empty_strided_cuda((256, 310), (1, 256), torch.float32)
            # Topologically Sorted Source Nodes: [input_16], Original ATen: [aten.threshold_backward, aten.native_batch_norm_backward, aten._native_batch_norm_legit_functional]
            stream0 = get_raw_stream(0)
            triton_red_fused__native_batch_norm_legit_functional_native_batch_norm_backward_threshold_backward_32.run(relu_4, buf67, convolution_5, unsqueeze_102, buf68, buf70, 79360, 423, stream=stream0)
            buf69 = buf59; del buf59  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.threshold_backward, aten.native_batch_norm_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused_native_batch_norm_backward_threshold_backward_33.run(buf68, buf69, 256, 310, stream=stream0)
            del buf68
            buf71 = empty_strided_cuda((256, ), (1, ), torch.float32)
            buf72 = empty_strided_cuda((256, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [input_16], Original ATen: [aten.threshold_backward, aten.native_batch_norm_backward, aten._native_batch_norm_legit_functional]
            stream0 = get_raw_stream(0)
            triton_red_fused__native_batch_norm_legit_functional_native_batch_norm_backward_threshold_backward_34.run(buf70, squeeze_13, buf71, buf72, 256, 310, stream=stream0)
            del buf70
            buf73 = relu_4; del relu_4  # reuse
            # Topologically Sorted Source Nodes: [input_16], Original ATen: [aten.threshold_backward, aten.native_batch_norm_backward, aten._native_batch_norm_legit_functional, aten.convolution_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused__native_batch_norm_legit_functional_convolution_backward_native_batch_norm_backward_threshold_backward_35.run(buf73, buf67, convolution_5, unsqueeze_102, buf71, squeeze_13, buf69, primals_31, 33554432, stream=stream0)
            del buf67
            del buf71
            del convolution_5
            del primals_31
            ...
            buf76 = buf74[1]
            assert_size_stride(buf76, (256, 128, 3, 3), (1152, 1, 384, 128), 'torch.ops.aten.convolution_backward.default')
            assert_alignment(buf76, 16, 'torch.ops.aten.convolution_backward.default')
            del buf74
            buf77 = empty_strided_cuda((256, 128, 3, 3), (1152, 1, 384, 128), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_36.run(buf76, buf77, 294912, stream=stream0)
            del buf76
            ...
            del primals_26
            buf79 = reinterpret_tensor(buf58, (128, 512), (1, 128), 0); del buf58  # reuse
            buf81 = reinterpret_tensor(buf56, (128, 512), (1, 128), 0); del buf56  # reuse
            # Topologically Sorted Source Nodes: [input_12], Original ATen: [aten._native_batch_norm_legit_functional, aten.native_batch_norm_backward]
            stream0 = get_raw_stream(0)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    convert_element_type_14 = rand_strided((256, 128, 3, 3), (1152, 1, 384, 128), device='cuda:0', dtype=torch.bfloat16)
    convolution_5 = rand_strided((512, 256, 16, 16), (65536, 1, 4096, 256), device='cuda:0', dtype=torch.bfloat16)
    squeeze_13 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    relu_4 = rand_strided((512, 256, 16, 16), (65536, 1, 4096, 256), device='cuda:0', dtype=torch.bfloat16)
    getitem_12 = rand_strided((512, 256, 8, 8), (16384, 1, 2048, 256), device='cuda:0', dtype=torch.bfloat16)
    getitem_13 = rand_strided((512, 256, 8, 8), (16384, 1, 2048, 256), device='cuda:0', dtype=torch.int8)
    convert_element_type_17 = rand_strided((256, 256, 3, 3), (2304, 1, 768, 256), device='cuda:0', dtype=torch.bfloat16)
    convolution_6 = rand_strided((512, 256, 8, 8), (16384, 1, 2048, 256), device='cuda:0', dtype=torch.bfloat16)
    squeeze_16 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    relu_5 = rand_strided((512, 256, 8, 8), (16384, 1, 2048, 256), device='cuda:0', dtype=torch.bfloat16)
    convert_element_type_20 = rand_strided((256, 256, 3, 3), (2304, 1, 768, 256), device='cuda:0', dtype=torch.bfloat16)
    convolution_7 = rand_strided((512, 256, 8, 8), (16384, 1, 2048, 256), device='cuda:0', dtype=torch.bfloat16)
    getitem_17 = rand_strided((1, 256, 1, 1), (256, 1, 256, 256), device='cuda:0', dtype=torch.float32)
    rsqrt_6 = rand_strided((1, 256, 1, 1), (256, 1, 256, 256), device='cuda:0', dtype=torch.float32)
    convert_element_type_23 = rand_strided((512, 256, 3, 3), (2304, 1, 768, 256), device='cuda:0', dtype=torch.bfloat16)
    convert_element_type_24 = rand_strided((512, 256, 8, 8), (16384, 1, 2048, 256), device='cuda:0', dtype=torch.bfloat16)
    ...
    unsqueeze_90 = rand_strided((1, 256, 1, 1), (256, 1, 1, 1), device='cuda:0', dtype=torch.float32)
    unsqueeze_102 = rand_strided((1, 256, 1, 1), (256, 1, 1, 1), device='cuda:0', dtype=torch.float32)
