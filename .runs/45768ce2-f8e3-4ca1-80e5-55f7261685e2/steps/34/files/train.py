...
MIXUP_ALPHA = 0.2
LABEL_SMOOTHING = 0.1
SAFETY_MARGIN = 0.95  # Changed from 0.90 to 0.95 for better cosine schedule calibration
evaluator = Eval()
...
def train(seed=42, time_budget_s=TIME_BUDGET_S):
    ...
    estimated_total_steps = int(time_budget_s / avg_step_time * SAFETY_MARGIN)
