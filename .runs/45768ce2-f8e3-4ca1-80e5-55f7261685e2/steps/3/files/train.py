...
def train(seed=42, time_budget_s=TIME_BUDGET_S):
    ...
    # Estimate total steps we can do in the time budget
    # PreActResNet-18 is bigger, so roughly ~25 epochs in 300s
    # Use cosine annealing with warm restarts
    estimated_epochs = 30
    steps_per_epoch = len(train_loader)
    estimated_total_steps = estimated_epochs * steps_per_epoch
    ...
    # Use torch.compile if available for speed
