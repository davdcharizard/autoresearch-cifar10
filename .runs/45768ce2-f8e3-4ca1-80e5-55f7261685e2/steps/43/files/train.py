...
# ---------------------------------------------------------------------------
# PreAct ResNet-18 with optional dropout
# ---------------------------------------------------------------------------
...
class PreActResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, width_mult=1, dropout=0.0):
        super().__init__()
        self.in_planes = 64
...
def PreActResNet18(num_classes=10, dropout=0.0):
...
def train(seed=42, time_budget_s=TIME_BUDGET_S):
    ...
    model = PreActResNet18(NUM_CLASSES, dropout=DROPOUT).to(device)
