...
And yes CIFAR-10 makes it possible to run on any GPU and not just H100. For the local machine for this particular autoresearch test bench, the local machine has access to two H20 gpus. Using one should be enough for autoresearch loops.
